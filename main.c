...
int main(){
	...
	printf(" Enter 20 for modulus \n");
	 printf(" Enter 21 for percentage \n");
	while(1){
...
void logarithm() {
 ...
 void natural_logarithm() {
   double log_, num;
	...
	void modulus() {
    int a, b;
    printf(" Enter two numbers for modulus operation :\n");
    scanf("%d %d", &a, &b);
    printf("The modulus of %d and %d is %d\n", a, b, a % b);
}
void percentage() {
    double base, percentage;
    printf(" Enter the base and percentage value :\n");
    scanf("%lf %lf", &base, &percentage);
    double result = (percentage / 100) * base;
